...
import { BarChart3, ArrowRight, CheckCircle2, PieChart, TrendingUp, Database } from 'lucide-react';
...
export default function AnalyticsPage() {
  ...
  const services = [
    ...
    },
    {
      ...
      desc: 'Forecast trends and patterns'
    },
    {
      icon: Database,
      title: 'Data Engineering',
      desc: 'Robust data infrastructure'
    }
  ];
    ...
    <section className="min-h-screen pt-32 pb-24 bg-slate-50 dark:bg-slate-950">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <motion.div
          ...
          className="mb-16"
        >
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-amber-50 dark:bg-amber-950/30 border border-amber-200 dark:border-amber-800 text-amber-600 text-sm font-medium mb-6">
            <BarChart3 className="w-4 h-4" />
            Enterprise Solution
          </div>
          
          <h1 className="text-5xl md:text-6xl font-bold text-slate-900 dark:text-white mb-6">
            Data <span className="text-amber-600">Analytics</span>
          </h1>
          
          <p className="text-xl text-slate-600 dark:text-slate-400 max-w-3xl leading-relaxed">
            Turn raw data into actionable insights. Our analytics solutions help you make 
            data-driven decisions and unlock business value.
          </p>
        </motion.div>
